...
export const DefenseForm: React.FC<DefenseFormProps> = ({
  case_,
  onSubmit,
  onBack,
  loading = false,
  ...
  return (
    <div
      ...
      style={{ backgroundImage: 'url(/Defend-Background.png)' }}
    >
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-120px)]">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 order-1">
          ...
          <section
            className="bg-white border-4 border-blue-600 rounded-lg shadow-xl p-4 sm:p-6 mb-6"
            aria-labelledby="case-details-heading"
          >
            <h1
              id="case-details-heading"
              className="text-xl sm:text-2xl font-bold mb-4 text-blue-600"
            >
              Case Details
            </h1>
          ...
          <form
            ...
            className="bg-white border-4 border-blue-600 rounded-lg shadow-xl p-4 sm:p-6"
            id="defense-form"
            aria-labelledby="defense-form-heading"
          >
            <h2
              id="defense-form-heading"
              className="text-xl sm:text-2xl font-bold mb-4 text-blue-600"
            >
              Your Defense
            </h2>
              ...
              <div className="mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Your case has been posted for jury voting. The community will now vote on your
                      defense!
                    </p>
                  </div>
                </div>
            ...
            <div className="text-center">
              <button
                ...
                className={`w-full sm:w-auto py-3 px-8 rounded-lg font-bold transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl text-sm sm:text-base border-2 border-black ${
                  isValid && !loading
      ...
      <div className="fixed bottom-4 left-4 right-4">
        <button
          ...
          onClick={onBack}
          disabled={loading}
          className="w-full bg-blue-600 border-4 border-black text-white font-bold py-4 rounded-lg text-lg hover:bg-blue-700 hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
