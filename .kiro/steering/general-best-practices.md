...
- Focus on the immediumiate need rather than anticipating future requirements
...
- **Immediumiate cleanup**: Remove test files as soon as testing is complete, don't leave them for later cleanup
...
- **Don't modify devvit.json**: Only change Devvit configuration when explicitly needed and confirmedium by the developer.
